        ...
        <div className="mx-auto grid max-w-7xl lg:grid-cols-2">
          <div className="px-6 pb-24 pt-16 sm:pb-32 sm:pt-20 lg:col-start-2 lg:px-8 lg:pt-32">
            <div className="mx-auto max-w-2xl lg:mr-0 lg:max-w-lg">
              ...
              >
                Relied Upon by the Creative Community
              </p>
              <p
              ...
              >
                Our platform boasts excellent statistics that highlight our commitment to providing a reliable and rewarding experience for creators. With a diverse and active user base, low fees, and a substantial amount paid out to creators, our track record speaks for itself.
              </p>
